...
%% Identifying players with high scores within the SVD dimensions
...
disp(F)
%% Which offensive stats contribute to a player's ranking
v = abs(V);
v_Max = max(v(:,1:5));
F = [0 0 0 0 0]
...
disp(F)
%% Fitting a linear model to he 1st and 2nd SVD dimenions
clf
